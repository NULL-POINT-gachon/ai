...
class DummyRecommendationService:
    ...
    def __init__(self):
        ...
        self.places = [
            ...
            },
            {
                ...
                "name": "전주 한옥마을",
                "type": "전통",
                "activities": ["문화 체험", "맛집 탐방", "전통 의상 체험"],
                "transport": ["대중교통", "자전거"],
            },
            {
                "id": "place_6",
        ...
        self.cities = [
            {
                "id": "city_1",
                "name": "서울",
                "activities": ["쇼핑", "맛집 탐방", "문화 체험", "역사 탐방"],
            },
            {
                "id": "city_2",
                "name": "부산",
                "activities": ["해수욕", "맛집 탐방", "야경 감상", "쇼핑"],
            },
            {
                "id": "city_3",
                "name": "제주",
                "activities": ["자연 감상", "트레킹", "해수욕", "맛집 탐방"],
            },
            {
                "id": "city_4",
                "name": "경주",
                "activities": ["역사 탐방", "문화 체험", "사진 촬영", "자전거"],
            },
            {
                "id": "city_5",
                "name": "전주",
                "activities": ["맛집 탐방", "문화 체험", "전통 의상 체험", "역사 탐방"],
            },
            {
                "id": "city_6",
                "name": "강릉",
                "activities": ["해수욕", "맛집 탐방", "카페 투어", "자연 감상"],
            },
            {
                "id": "city_7",
                "name": "여수",
                "activities": ["야경 감상", "맛집 탐방", "해수욕", "크루즈"],
            },
            {
                "id": "city_8",
                "name": "속초",
                "activities": ["맛집 탐방", "해수욕", "온천", "시장"],
            },
            {
                "id": "city_9",
                "name": "안동",
                "activities": ["문화 체험", "역사 탐방", "맛집 탐방", "사진 촬영"],
            },
            {
                "id": "city_10",
                "name": "춘천",
                "activities": ["자연 감상", "수상 스포츠", "맛집 탐방", "데이트"],
            },
        ]
    ...
    def get_recommendations(
        ...
        if user_profile and user_profile.preferred_activities:
            ...
            places_to_recommend.sort(
                key=lambda x: self._calculate_activity_match_score(
                    x, user_profile.preferred_activities
                ),
                reverse=True,
            )
        else:
        ...
        if user_profile:
            user_preference_summary = {
                "top_activities": (
                    user_profile.preferred_activities[:3]
                    if user_profile.preferred_activities
                    else ["여행", "관광", "휴식"]
                ),
                "preferred_transport": (
                    user_profile.preferred_transport[:2]
                    if user_profile.preferred_transport
                    else ["대중교통"]
                ),
            }
    ...
    def get_city_recommendations(
        self, user_id=None, user_profile=None, top_n=5, alpha=0.5
    ):
        """
        도시 추천 더미 구현
        ...
        # 더미 응답 반환
        return {"user_id": user_id or "anonymous", "recommendations": recommendations}
    ...
    def _calculate_activity_match_score(self, item, preferred_activities):
        ...
        return (
            matches
            / max(1, len(activities))
            * (matches / max(1, len(preferred_activities)))
        )
