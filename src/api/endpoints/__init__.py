...
from src.api.endpoints.deployment import (
    register_endpoints as register_deployment_endpoints,
)
from src.api.endpoints.model import (
    register_model_endpoints,
    register_incident_endpoints,
)
from src.api.endpoints.recommendation import (
    register_endpoints as register_recommendation_endpoints,
)
