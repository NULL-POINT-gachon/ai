...
# 상세 여행지 추천 테스트
echo -e "\n\n========== 상세 여행지 추천 테스트 =========="
python ai_recommendation.py --mode detail --city "서울특별시" --activity_type "실내" --activity_ids 1,3,5 --emotion_ids 3 --preferred_transport "대중교통" --companions_count 5 --activity_level 1 --top_n 3 --alpha 0.7
