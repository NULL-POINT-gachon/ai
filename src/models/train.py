...
# 데이터 불러오기 및 전처리
df, encoders = load_and_preprocess_data("C:/Users/adminastor/proj_main_6/data/raw/final_merge_outer.csv")

feature_cols = [
    'user_id', 'item_id', 'GENDER', 'AGE_GRP',
    'TRAVEL_COMPANIONS_NUM', 'TRAVEL_MOTIVES', 'TRAVEL_STYLES',
    'VISIT_CHC_REASON_CD', 'TRAVEL_PURPOSE'
]
X = df[feature_cols]
y = df['label']
...
model.fit(train_inputs, y_train, epochs=10, batch_size=64, validation_data=(val_inputs, y_val))
